...
import AccordionAnswerSection from "../components/accordion-answer-section";
  ...
  return (
    <div className={styles.busPassStudentPasses}>
      ...
      <section className={styles.busPassStudentPasses1}>
        ...
        <AccordionContainer />
        <div className={styles.accordionAnswerSectionParent}>
          <AccordionAnswerSection />
          <div className={styles.accordion}>
            <div className={styles.bg} />
            <div className={styles.before6AmContainer}>
              <ol className={styles.districtsHighSchoolColl}>
                <li>Districts - High School / College Student Bus Pass</li>
              </ol>
            </div>
            <img
        ...
        <div className={styles.accordion1}>
          ...
          <div className={styles.before6AmContainer1}>
            <ol className={styles.exclusiveTripsToSpecialSch}>
              <li>Exclusive trips to special schools / colleges</li>
            </ol>
          </div>
          <img
