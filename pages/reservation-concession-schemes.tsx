    ...
    return (
      <div className={styles.reservationConcessionSchemes}>
        <Header2
          ...
          prop="/---7.svg"
          tELANGANASTATEROADTRANSPO="/telangana-state-road-transport-corporation6.svg"
        ...
        <section className={styles.reservationHeroConcessionSc}>
          ...
          />
          <h1 className={styles.concessionSchemes}>Concession Schemes</h1>
          <h2
        ...
        <section className={styles.reservationConcessionSchemes1}>
                ...
                <div className={styles.bulletPoints}>
                  <div className={styles.bulletPoint}>
                    ...
                    <div className={styles.monthlySeasonTickets1}>
                      Monthly Season Tickets are issued separately for
                      Pallevelugu and Express types of buses by collecting 20
                      days fare for one month travel.
                    </div>
                  </div>
                  ...
                  <div className={styles.bulletPoints1}>
                    <div className={styles.bulletPoint20}>
                      ...
                      <div className={styles.monthlySeasonTickets21}>
                        ...
                        travel in Express buses by paying a flat fare of Rs.10/-
                        for each journey on the permitted route.
                      </div>
                    </div>
                    <div className={styles.bulletPoint21}>
                      ...
                      <div className={styles.monthlySeasonTickets22}>
                        Express Monthly Season Ticket holder is permitted to
                        travel in Deluxe buses by paying a flat fare of Rs.20/-
                        for each journey on the permitted route
                      </div>
                    </div>
                    <div className={styles.bulletPoint22}>
                      ...
                      <div className={styles.monthlySeasonTickets23}>
                        Passengers intending to travel from 76th km to 100th Km
                        are facilitated to travel with a single slab tariff of
                        80 Kms fare.
                      </div>
                    </div>
                    ...
                    <div className={styles.bulletPoint27}>
                      ...
                      <div className={styles.monthlySeasonTickets28}>
                        In case if the BoC service does not pass through Toll
                        gate, the appplicable amount will be refunded to the
                        hirer
                      </div>
                    </div>
                    ...
                    <div className={styles.bulletPoint33}>
                      <img
                        className={styles.bulltetPointPlaceholder33}
                        alt=""
                      />
                    ...
                    <div className={styles.bulletPoint34}>
                      <img
                        className={styles.bulltetPointPlaceholder34}
                        alt=""
                      />
                    ...
                    <div className={styles.bulletPoint35}>
                      <img
                        className={styles.bulltetPointPlaceholder35}
                        alt=""
                      />
                    ...
                    <div className={styles.bulletPoint36}>
                      <img
                        className={styles.bulltetPointPlaceholder36}
                        alt=""
                      />
                    ...
                    <div className={styles.bulletPoint37}>
                      <img
                        className={styles.bulltetPointPlaceholder37}
                        alt=""
                      />
                    ...
                    <div className={styles.bulletPoint38}>
                      <img
                        className={styles.bulltetPointPlaceholder38}
                        alt=""
                      />
                    ...
                    <div className={styles.bulletPoint39}>
                      <img
                        className={styles.bulltetPointPlaceholder39}
                        alt=""
                      />
          ...
          <div className={styles.tableTitleWrapper}>
            <div className={styles.tableTitle}>
              <div className={styles.title2}>
                Tariffs of monthly season tickets:
              </div>
                  ...
                  <div className={styles.coulmn2}>
                    ...
                    <div className={styles.contentCell}>
                      <div className={styles.cells17}>
                        ...
                        <div className={styles.name19}>0-5</div>
                      </div>
                  ...
                  <div className={styles.column5}>
                    ...
                    <div className={styles.contentCell3}>
                      <div className={styles.cells68}>
                        ...
                        <div className={styles.name70}>500.00</div>
                      </div>
                      <div className={styles.cells69}>
                        <div className={styles.bg65} />
                        <input
                          className={styles.name71}
                          placeholder="500.00"
                          type="text"
                        />
                      </div>
                  ...
                  <div className={styles.column6}>
                    ...
                    <div className={styles.contentCell4}>
                      <div className={styles.cells85}>
                        ...
                        <div className={styles.name87}>NO TICKET</div>
                      </div>
                      <div className={styles.cells86}>
                        <div className={styles.bg81} />
                        <input
                          className={styles.name88}
          ...
          <div className={styles.frameParent}>
            <div className={styles.travel24t24TicketsParent}>
              <h2 className={styles.travel24t24Tickets}>
                Travel-24(T-24) Tickets
              </h2>
              <div className={styles.travel24t24TicketsWereContainer}>
                <p className={styles.travel24t24TicketsWere}>
                ...
                <p className={styles.t24TicketCan}>
