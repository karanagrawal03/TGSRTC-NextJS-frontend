...
const LogisticContacts: NextPageLogisticContactsType = () => {
  return (
    <div className={styles.logisticContacts}>
      ...
      />
      <section className={styles.logisticHeroContacts}>
        <img className={styles.bgIcon} alt="" src="/bg@2x.png" />
        <h1 className={styles.logisticContacts1}>Logistic Contacts</h1>
      ...
      <section className={styles.logisticTable}>
        <div className={styles.tableTitle}>
          <h2 className={styles.title}>List of logistic contact details</h2>
              ...
              <div className={styles.column3}>
                ...
                <div className={styles.contentCell1}>
                  <div className={styles.cells34}>
                    ...
                    <div className={styles.name36}>Parcel Counters</div>
                  </div>
                  <div className={styles.cells35}>
                    <div className={styles.bg33} />
                    <input
                      className={styles.name37}
                      placeholder="Marketing Executives"
                      type="text"
                    />
                  </div>
                  ...
                  <div className={styles.cells37}>
                    ...
                    <input
                      ...
                      placeholder={`GMR & TSRTC Jointly Cargo Transport`}
                      type="text"
                    />
                  </div>
        ...
        <div className={styles.footerSection}>
          <div className={styles.logo}>
            ...
            <div className={styles.logoTextGroup}>
              <img className={styles.icon} alt="" src="/----17.svg" />
              <img
        ...
        <div className={styles.recognitionAndSocialMediaC}>
          <div className={styles.recognitionContainerWrapper}>
            <div className={styles.recognitionContainer}>
              ...
              <button className={styles.recognitionBackground}>
                <img
