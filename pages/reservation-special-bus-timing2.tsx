...
import styles from "./reservation-special-bus-timing2.module.css";

const ReservationSpecialBusTiming2: NextPageReservationSpecialBusTiming2Type =
  () => {
    return (
      <div className={styles.reservationSpecialBusTiming}>
        ...
        />
        <section className={styles.reservationHyderabadToYadag}>
          <div className={styles.tabsAboutAirportPushpak}>
            ...
            <div className={styles.afterMoreThanContainer}>
              <p className={styles.afterMoreThan}>
                After more than five years of renovation and reconstruction,
                Telangana’s Yadadri (Yadagirigutta) temple has transformed from
                a small hill shrine into a magnificent and sprawling pilgrimage
                centre. To help pilgrims reach the shrine, TSRTC has started
                special buses that go to Yadadri. Now you have 104 buses from
                Hyderabad to Yadadri (Yadagirigutta). JBS to Yadagirigutta bus
                timings and MGBS to Yadagirigutta bus timings are set up in such
                a way that there are ample options for pilgrims to choose from.
              </p>
              <p className={styles.blankLine}>&nbsp;</p>
              <p className={styles.locatedAbout60}>
                Located about 60 km from Hyderabad, it has undergone a complete
                transformation in line with Chief Minister K. Chandrasekhar
                Rao’s ambitious vision. To realize his vision, Yadagirigutta bus
                timings and also Yadagirigutta ticket price are carefully
                planned so as to provide citizens with cheap, safe and secure
                travelling service. Be it JBS to Yadagirigutta bus ticket price
                or MGBS to Yadagirigutta ticket price, TSRTC is determined to
                provide cost-effective, pocket-friendly and the best service.
              </p>
              <p className={styles.blankLine1}>&nbsp;</p>
              <p className={styles.chooseTsrtcMake}>
                Choose TSRTC. Make Hyderabad to Yadadri journey safe, secure and
                simpl
              </p>
            </div>
          </div>
              ...
              <form className={styles.table1}>
                ...
                <div className={styles.column4}>
                  <button className={styles.cells50}>
                    <div className={styles.name52}>Service Type</div>
                  </button>
                  <div className={styles.contentCell2}>
                    <div className={styles.cells51}>
                      <div className={styles.bg48} />
                      <div className={styles.name53}>Pallevelugu</div>
                    </div>
                    <button className={styles.cells52}>
                      <div className={styles.bg49} />
                      <div className={styles.name54}>Pallevelugu</div>
                    </button>
                    <div className={styles.cells53}>
                      <div className={styles.bg50} />
                      <div className={styles.name55}>Pallevelugu</div>
                    </div>
                    <button className={styles.cells54}>
                      <div className={styles.bg51} />
                      <div className={styles.name56}>Pallevelugu</div>
                    </button>
                ...
                <div className={styles.column5}>
                  <button className={styles.cells67}>
                    <div className={styles.name69}>From Stage</div>
                  </button>
                  <div className={styles.contentCell3}>
                    <div className={styles.cells68}>
                      <div className={styles.bg64} />
                      <div className={styles.name70}>Hyderabad</div>
                    </div>
                    <button className={styles.cells69}>
                      <div className={styles.bg65} />
                      <div className={styles.name71}>Hyderabad</div>
                    </button>
                    <div className={styles.cells70}>
                      <div className={styles.bg66} />
                      <div className={styles.name72}>Hyderabad</div>
                    </div>
                    <button className={styles.cells71}>
                      <div className={styles.bg67} />
                      <div className={styles.name73}>Hyderabad</div>
                    </button>
                ...
                <div className={styles.column7}>
                  <div className={styles.cells101}>
                    <div className={styles.name103}>To Stage</div>
                  </div>
                  <div className={styles.contentCell5}>
                    <div className={styles.cells102}>
                      <div className={styles.bg96} />
                      <div className={styles.name104}>Yadagirigutta</div>
                    </div>
                    <button className={styles.cells103}>
                      <div className={styles.bg97} />
                      <div className={styles.name105}>Yadagirigutta</div>
                    </button>
                    <div className={styles.cells104}>
                      <div className={styles.bg98} />
                      <div className={styles.name106}>Yadagirigutta</div>
                    </div>
                    <button className={styles.cells105}>
                      <div className={styles.bg99} />
                      <div className={styles.name107}>Yadagirigutta</div>
                    </button>
                ...
                <div className={styles.column8}>
                  ...
                  <div className={styles.contentCell6}>
                    ...
                    <div className={styles.cells121}>
                      ...
                      <div className={styles.name123}>07:50</div>
                    </div>
                    <div className={styles.cells122}>
                      <div className={styles.bg115} />
                      <input
                        className={styles.name124}
                        placeholder="08:20"
                        type="text"
                      />
                    </div>
...
export default ReservationSpecialBusTiming2;
