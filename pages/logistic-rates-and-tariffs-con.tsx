...
import LogisticBookYourCargoSecti from "../components/logistic-book-your-cargo-secti";
import styles from "./logistic-rates-and-tariffs-con.module.css";

const LogisticRatesAndTariffsCon: NextPageLogisticRatesAndTariffsConType =
  () => {
    return (
      <div className={styles.logisticRatesAndTariffsCon}>
        ...
        <section className={styles.logisticHeroRatesTariffC}>
          ...
          <h1 className={styles.logisticRatesAndContainer}>
            <p className={styles.logisticRatesAnd}>Logistic Rates and</p>
            <p className={styles.tariffsContacts}>Tariffs Contacts</p>
          </h1>
...
export default LogisticRatesAndTariffsCon;
