...
const Tenders: NextPageTendersType = () => {
  return (
    <div className={styles.tenders}>
      <header className={styles.header}>
        ...
        <div className={styles.tabContainer}>
          ...
          <div className={styles.navTabs5}>
            <b className={styles.reservations5}>Tenders</b>
          </div>
      ...
      <section className={styles.tendersDetails}>
        <div className={styles.sideTabSelectionContainerWrapper}>
            ...
            <div className={styles.table1}>
              ...
              <div className={styles.column3}>
                ...
                <div className={styles.contentCell1}>
                  ...
                  <div className={styles.cells40}>
                    ...
                    >{`Notification for Sweeping Cleaning & Washing of buses to the depots etc.,Bus stations Sweeping of old bus stations,Maintenance contract of Bus station including sweeping cleaning etc., and HSD oil topup to the depots, Asst. to the Mechanics , Garrage Sweeping works to the depot of Khammam Region`}</div>
                  </div>
              ...
              <div className={styles.actionCell}>
                ...
                <div className={styles.contentCell11}>
                  ...
                  <div className={styles.buttonCellsGroup}>
                  ...
                  <div className={styles.buttonCellsContainer}>
                  ...
                  <div className={styles.buttonCells15}>
                    ...
                    <div className={styles.actions15}>
                      ...
                      <div className={styles.button31}>
                        <div className={styles.viewDetails32}>View Details</div>
                      </div>
        ...
        <div className={styles.footerSection}>
          <div className={styles.logo}>
            ...
            <div className={styles.logoTextGroup}>
              <img className={styles.icon1} alt="" src="/----14.svg" />
              <img
