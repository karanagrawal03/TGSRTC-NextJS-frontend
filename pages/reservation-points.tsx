  ...
  return (
    <div className={styles.reservationPoints}>
      <Header2
        ...
        prop="/---9.svg"
        tELANGANASTATEROADTRANSPO="/telangana-state-road-transport-corporation8.svg"
      ...
      />
      <section className={styles.reservationHeroReservationP}>
        <img className={styles.maskGroupIcon} alt="" src="/mask-group@2x.png" />
        <h1 className={styles.reservationPoints1}>Reservation Points</h1>
        <h2
          className={styles.applyRenew}
        >{`Apply, Renew & Travel effortlessly with TSRTC`}</h2>
      </section>
      <section className={styles.reservationDetailsOfReserva}>
        <div className={styles.tableTitle}>
          <h2 className={styles.title}>Details of Reservation Points</h2>
      ...
      <section className={styles.footer}>
          ...
          <div className={styles.logo}>
            ...
            <div className={styles.logoTextGroup}>
              ...
              <img
                ...
                alt=""
                src="/telangana-state-road-transport-corporation-15.svg"
              />
            </div>
          </div>
        ...
        <footer className={styles.recognitionAndSocialMediaC}>
          <div className={styles.recognitionSocial}>
