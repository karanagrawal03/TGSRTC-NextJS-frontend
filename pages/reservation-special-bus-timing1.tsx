...
import MiyapurDepotCard2 from "../components/miyapur-depot-card2";
import MiyapurDepotCard1 from "../components/miyapur-depot-card1";
import MiyapurDepotCard from "../components/miyapur-depot-card";
import styles from "./reservation-special-bus-timing1.module.css";

const ReservationSpecialBusTiming1 = () => {
  return (
    <div className={styles.reservationSpecialBusTiming}>
      ...
      />
      <main className={styles.reservationAirportPushpak}>
        <section className={styles.tabsAboutAirportPushpak}>
          ...
          <p className={styles.pushpakIsAContainer}>
            <span className={styles.pushpakIsA}>
              Pushpak is a special AC service provided by TGSRTCUntil now it is
              known as a special service only to the airport, but Pushpak
              airport liner buses are not exclusive buses to the airport - they
              pick up and drop commuters at many locations in the city. If you
              search for ‘Pushpak airport liner near me’ in a search engine, you
              may find a few stops near you where you can board Pushpak buses
              and get down at any Pushpak bus stop or even go to the airport.
              Because it goes till the airport it is called the airport bus
              shuttle. So, if you search ‘airport bus stop near me’, you will
              get the details of Pushpak bus stops near your location.
            </span>
            <span className={styles.blankLine}>&nbsp;</span>
            <span className={styles.pushpakBusTimings}>
              ...
              timings. You can avail the tickets directly in the bus. Pushpak is
              the only AC service in Hyderabad and it is safe, secure and fast.
              Pushpak not only goes to the airport, but to many other
              ...
              <div className={styles.table1}>
                ...
                <div className={styles.column5}>
                  ...
                  <div className={styles.contentCell3}>
                    ...
                    <div className={styles.cells71}>
                      ...
                      <div className={styles.name73}>AJ</div>
                    </div>
                ...
                <div className={styles.column9}>
                  <div className={styles.cells135}>
                    <b className={styles.name137}>Via</b>
                  </div>
                  <div className={styles.contentCell7}>
                    <div className={styles.cells136}>
                      <div className={styles.bg128} />
                      <div
                        className={styles.name138}
                      >{`Sangeeth, Tarnaka, Uppal X Rd, L B Nagar, Balapur, Pahadisharif `}</div>
                    </div>
                    <div className={styles.cells137}>
                      <div className={styles.bg129} />
                      <p className={styles.name139}>
                        <span className={styles.paradiseSecretariatNampall}>
                          Paradise, Secretariat, Nampally, Afzulganj,
                          Bahadhurpur, Aramghar,
                        </span>
                        <span className={styles.shamshabad}>Shamshabad</span>
                      </p>
                    </div>
                    <div className={styles.cells138}>
                      <div className={styles.bg130} />
                      <p className={styles.name140}>
                        <span className={styles.secundarabadBegumpetPanjag}>
                          Secundarabad, Begumpet, Panjagutta, Banjarahills,
                          Masab Tank, Aramghar,
                        </span>
                        <span className={styles.shamshabad1}>Shamshabad</span>
                      </p>
                    </div>
                    <div className={styles.cells139}>
                      <div className={styles.bg131} />
                      <div className={styles.name141}>
                ...
                <div className={styles.coulmn21}>
                  ...
                  <div className={styles.contentCell12}>
                    <div className={styles.cells221}>
                      ...
                      <div className={styles.name225}>0-5</div>
                    </div>
        ...
        <div className={styles.tgsrtcMiyapur2DepotPushpaParent}>
          <h2 className={styles.tgsrtcMiyapur2}>
            TGSRTC Miyapur -2 Depot Pushpak Service Operations
          </h2>
          <div className={styles.tgsrtcAirportPushpak}>
