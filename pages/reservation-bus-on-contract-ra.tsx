  ...
  () => {
    return (
      <div className={styles.reservationBusOnContractRa}>
        ...
        />
        <div className={styles.reservationHeroContractRate}>
          <img
            className={styles.maskGroupIcon}
            alt=""
            src="/mask-group@2x.png"
          />
          <h1 className={styles.busOnContract}>Bus on Contract Rates</h1>
          <h2 className={styles.tsrtcIsHappy}>
            TSRTC is happy to announce the following package tours to our
            valuable commuters at affordable rates.
          </h2>
        </div>
        <main className={styles.reservationContractRatesTab}>
          ...
          <section className={styles.tableTitleParent}>
                ...
                <form className={styles.table3}>
                  ...
                  <div className={styles.coulmn21}>
                    ...
                    <div className={styles.contentCell12}>
                      ...
                      <div className={styles.cells224}>
                        ...
                        <div className={styles.name228}>Deluxe</div>
                      </div>
                  ...
                  <div className={styles.column31}>
                    <div className={styles.cells237}>
                      <div className={styles.name241}>
                        <p className={styles.permissible}>Permissible</p>
                        <p className={styles.seatingCapacity}>
                          seating Capacity{" "}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className={styles.column41}>
                    ...
                    <div className={styles.contentCell14}>
                      <div className={styles.cells255}>
                        ...
                        <div className={styles.name259}>41.00</div>
                      </div>
                      <div className={styles.cells256}>
                        <div className={styles.bg257} />
                        <input
                          className={styles.name260}
                          placeholder="68.00"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells257}>
                        ...
                        <div className={styles.name261}>69.00</div>
                      </div>
                      <div className={styles.cells258}>
                        <div className={styles.bg259} />
                        <input
                          className={styles.name262}
                          placeholder="69.00"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells259}>
                        ...
                        <div className={styles.name263}>69.00</div>
                      </div>
                      <div className={styles.cells260}>
                        <div className={styles.bg261} />
                        <input
                          className={styles.name264}
                          placeholder="69.00"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells261}>
                        ...
                        <div className={styles.name265}>69.00</div>
                      </div>
                      <div className={styles.cells262}>
                        <div className={styles.bg263} />
                        <input
                          className={styles.name266}
                          placeholder="69.00"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells263}>
                        ...
                        <div className={styles.name267}>69.00</div>
                      </div>
                      <div className={styles.cells264}>
                        <div className={styles.bg265} />
                        <input
                          className={styles.name268}
                          placeholder="69.00"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells265}>
                        ...
                        <div className={styles.name269}>69.00</div>
                      </div>
                  ...
                  <div className={styles.column51}>
                    ...
                    <div className={styles.contentCell15}>
                      <div className={styles.cells272}>
                        ...
                        <div className={styles.name276}>30 Kms/Hr</div>
                      </div>
                      <button className={styles.cells273}>
                        <div className={styles.bg273} />
                        <div className={styles.name277}>30 Kms/Hr</div>
                      </button>
                      <div className={styles.cells274}>
                        <div className={styles.bg274} />
                        <div className={styles.name278}>30 Kms/Hr</div>
                      </div>
                      <button className={styles.cells275}>
                        <div className={styles.bg275} />
                        <div className={styles.name279}>30 Kms/Hr</div>
                      </button>
                      <div className={styles.cells276}>
                        <div className={styles.bg276} />
                        <div className={styles.name280}>30 Kms/Hr</div>
                      </div>
                      <button className={styles.cells277}>
                        <div className={styles.bg277} />
                        <div className={styles.name281}>30 Kms/Hr</div>
                      </button>
                      <div className={styles.cells278}>
                        <div className={styles.bg278} />
                        <div className={styles.name282}>30 Kms/Hr</div>
                      </div>
                      <button className={styles.cells279}>
                        <div className={styles.bg279} />
                        <div className={styles.name283}>30 Kms/Hr</div>
                      </button>
                      <div className={styles.cells280}>
                        <div className={styles.bg280} />
                        <div className={styles.name284}>30 Kms/Hr</div>
                      </div>
                      <button className={styles.cells281}>
                        <div className={styles.bg281} />
                        <div className={styles.name285}>30 Kms/Hr</div>
                      </button>
                      <div className={styles.cells282}>
                        <div className={styles.bg282} />
                        <div className={styles.name286}>30 Kms/Hr</div>
                      </div>
                  ...
                  <div className={styles.column61}>
                    <div className={styles.cells288}>
                      <div className={styles.name292}>
                        <p className={styles.waitingTime}>Waiting time</p>
                        <p className={styles.chargesRs}>Charges (Rs.) </p>
                      </div>
                    </div>
                    <div className={styles.contentCell16}>
                      <div className={styles.cells289}>
                        <div className={styles.bg288} />
                        <div className={styles.name293}>300/- per Hr</div>
                      </div>
                      <button className={styles.cells290}>
                        <div className={styles.bg289} />
                        <div className={styles.name294}>300/- per Hr</div>
                      </button>
                      <div className={styles.cells291}>
                        <div className={styles.bg290} />
                        <div className={styles.name295}>300/- per Hr</div>
                      </div>
                      <button className={styles.cells292}>
                        <div className={styles.bg291} />
                        <div className={styles.name296}>300/- per Hr</div>
                      </button>
                      <div className={styles.cells293}>
                        <div className={styles.bg292} />
                        <div className={styles.name297}>300/- per Hr</div>
                      </div>
                      <button className={styles.cells294}>
                        <div className={styles.bg293} />
                        <div className={styles.name298}>300/- per Hr</div>
                      </button>
                      <div className={styles.cells295}>
                        <div className={styles.bg294} />
                        <div className={styles.name299}>300/- per Hr</div>
                      </div>
                      <button className={styles.cells296}>
                        <div className={styles.bg295} />
                        <div className={styles.name300}>300/- per Hr</div>
                      </button>
                      <div className={styles.cells297}>
                        <div className={styles.bg296} />
                        <div className={styles.name301}>300/- per Hr</div>
                      </div>
                      <button className={styles.cells298}>
                        <div className={styles.bg297} />
                        <div className={styles.name302}>300/- per Hr</div>
                      </button>
                      <div className={styles.cells299}>
                        <div className={styles.bg298} />
                        <div className={styles.name303}>300/- per Hr</div>
                      </div>
            ...
            <div className={styles.text}>
              <div className={styles.forReckoningThe}>
                For reckoning the waiting time, an average running time @30 Kms
                per hour will be calculated for non-AC buses and @40 Kms per
                hour for A/C buses for the actual distance and the balance
                period will be treated as waiting time rounded off to next half
                hour.
              </div>
            </div>
          </section>
          <form className={styles.tableTitleGroup}>
            <div className={styles.tableTitle2}>
              <h2
                className={styles.title2}
              >{`Hire Charges for City Services (City Ordinary, Metro Express & Metro Deluxe services)(SLAB RATES)`}</h2>
              <div className={styles.table4}>
                <div className={styles.titleHeader2}>
                  <div className={styles.name412}>
                    Overview (Up to March - 2024)
                  </div>
                </div>
                  ...
                  <div className={styles.coulmn22}>
                    ...
                    <div className={styles.contentCell24}>
                      <div className={styles.cells425}>
                        ...
                        <div className={styles.name431}>6 Hrs for 90KMs</div>
                      </div>
                      <div className={styles.cells426}>
                        <div className={styles.bg433} />
                        <div className={styles.name432}>8 Hrs for 120KMs</div>
                      </div>
                      <div className={styles.cells427}>
                        <div className={styles.bg434} />
                        <div className={styles.name433}>10 Hrs for 150KMs</div>
                      </div>
                      <div className={styles.cells428}>
                        <div className={styles.bg435} />
                        <div className={styles.name434}>12 Hrs for 180KMs</div>
                      </div>
            ...
            <div className={styles.itemCellParent}>
              <div className={styles.itemCell}>
                <div
                  className={styles.after16Hours}
                >{`After 16 Hours, hire charges for 16 Hrs Plus @15KMs per Hour & Rate per KM`}</div>
              </div>
                  ...
                  <div className={styles.table7}>
                    ...
                    <div className={styles.actionCell3}>
                      <div className={styles.cells815}>
                        <div className={styles.name822}>Action</div>
                      </div>
                ...
                <div className={styles.bulletPoints}>
                  <div className={styles.bulletPoint}>
                    ...
                    <div className={styles.monthlySeasonTickets}>
                      Caution deposit amount shall not be collected from the
                      party.
                    </div>
                  </div>
                  ...
                  <div className={styles.bulletPoint2}>
                    ...
                    <div className={styles.monthlySeasonTickets2}>
                      To treat the customer, i.e. passenger, as a central
                      concern of the Corporation's business and provide the best
                      possible service.
                    </div>
                  </div>
                  <div className={styles.bulletPoint3}>
                    ...
                    <div className={styles.monthlySeasonTickets3}>
                      GST component for all services: GST without ITC @5%
                      (CGST-2.5% + SGST 2.5%) levied on the BoC amount + waiting
                      charges + permit fee + BoC service charges.
                    </div>
                  </div>
            ...
            <div className={styles.tableTitle4}>
              ...
              >{`Hire Charges for City Services (City Ordinary, Metro Express & Metro Deluxe services)(SLAB RATES)`}</div>
              <div className={styles.table8}>
                <div className={styles.titleHeader4}>
                  <div className={styles.name823}>
                    Overview (Up to March - 2024)
                  </div>
                </div>
                <div className={styles.table9}>
                  ...
                  <div className={styles.column34}>
                    ...
                    <div className={styles.contentCell49}>
                      <div className={styles.cells850}>
                        ...
                        <div className={styles.name859}>
                          a) If BoC amount is below Rs.10,000/-{" "}
                        </div>
                      </div>
                      <div className={styles.cells851}>
                        <div className={styles.bg865} />
                        <input
                          className={styles.name860}
                          placeholder="b) If BoC amount is above Rs.10,000/-	"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells852}>
                        ...
                        <div
                          className={styles.name861}
                        >{`c) From 48 Hrs before & up-to 24 Hrs before the departure time`}</div>
                      </div>
                      <div className={styles.cells853}>
                        <div className={styles.bg867} />
                        <div
                          className={styles.name862}
                        >{`d) From 24 Hrs before & up-to 2 Hrs before the departure time`}</div>
                      </div>
                      <div className={styles.cells854}>
                        <div className={styles.bg868} />
                        <div className={styles.name863}>Item</div>
                      </div>
                      <div className={styles.cells855}>
                        <div className={styles.bg869} />
                        <div className={styles.name864}>Item</div>
                      </div>
                      <div className={styles.cells856}>
                        <div className={styles.bg870} />
                        <div className={styles.name865}>Item</div>
                      </div>
                      <div className={styles.cells857}>
                        <div className={styles.bg871} />
                        <div className={styles.name866}>Item</div>
                      </div>
                      <div className={styles.cells858}>
                        <div className={styles.bg872} />
                        <div className={styles.name867}>Item</div>
                      </div>
                      <div className={styles.cells859}>
                        <div className={styles.bg873} />
                        <div className={styles.name868}>Item</div>
                      </div>
                      <div className={styles.cells860}>
                        <div className={styles.bg874} />
                        <div className={styles.name869}>Item</div>
                      </div>
                      <div className={styles.cells861}>
                        <div className={styles.bg875} />
                        <div className={styles.name870}>Item</div>
                      </div>
                      <div className={styles.cells862}>
                        <div className={styles.bg876} />
                        <div className={styles.name871}>Item</div>
                      </div>
                  ...
                  <div className={styles.column44}>
                    ...
                    <div className={styles.contentCell50}>
                      <div className={styles.cells867}>
                        ...
                        <div className={styles.name876}>Rs. 500/-</div>
                      </div>
                      <div className={styles.cells868}>
                        <div className={styles.bg881} />
                        <input
                          className={styles.name877}
                          placeholder="Rs. 500/-"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells869}>
                        ...
                        <div
                          className={styles.name878}
                        >{`10% on BoC amount subject to a minimum applicable as per (a) & (b)`}</div>
                      </div>
                      <div className={styles.cells870}>
                        <div className={styles.bg883} />
                        <input
                          className={styles.name879}
                          placeholder="30% on BoC amount"
                          type="text"
                        />
                      </div>
                      <div className={styles.cells871}>
                        <div className={styles.bg884} />
                        <div className={styles.name880}>Item</div>
                      </div>
                  ...
                  <div className={styles.actionCell4}>
                    <div className={styles.cells1019}>
                      <div className={styles.name1028}>Action</div>
                    </div>
          ...
          <section className={styles.annexureContainer}>
            ...
            <div className={styles.bulletPointContainer1}>
              <div className={styles.title6}>
                <h2
                  className={styles.guidingPrinciplesOf1}
                >{`TERMS & CONDITIONS`}</h2>
              </div>
              <div className={styles.bulletPoints1}>
                <div className={styles.bulletPoint20}>
                  ...
                  <div className={styles.monthlySeasonTickets20}>
                    TSRTC does not take responsibility for any delay/damages
                ...
                <div className={styles.bulletPoint21}>
                  ...
                  />
                  <div
                    className={styles.monthlySeasonTickets21}
                  >{`No over load shall be allowed on the bus given for hire. In case of any over loading, fare shall be charged additionally by issuing ticket for each additional passenger separately for both UP & DOWN journeys`}</div>
                </div>
                ...
                <div className={styles.bulletPoint23}>
                  <img
                    className={styles.bulltetPointPlaceholder23}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint24}>
                  <img
                    className={styles.bulltetPointPlaceholder24}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint25}>
                  <img
                    className={styles.bulltetPointPlaceholder25}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint26}>
                  <img
                    className={styles.bulltetPointPlaceholder26}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint27}>
                  <img
                    className={styles.bulltetPointPlaceholder27}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint28}>
                  <img
                    className={styles.bulltetPointPlaceholder28}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint29}>
                  <img
                    className={styles.bulltetPointPlaceholder29}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint30}>
                  <img
                    className={styles.bulltetPointPlaceholder30}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint31}>
                  <img
                    className={styles.bulltetPointPlaceholder31}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
                ...
                <div className={styles.bulletPoint32}>
                  <img
                    className={styles.bulltetPointPlaceholder32}
                    alt=""
                    src="/bulltet-point-placeholder.svg"
                  />
          ...
          <div className={styles.footerSection}>
            <div className={styles.logo}>
              ...
              <div className={styles.logoTextGroup}>
                <img className={styles.icon} alt="" src="/----12.svg" />
                <img
