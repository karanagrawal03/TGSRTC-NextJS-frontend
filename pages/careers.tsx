...
const Careers: NextPageCareersType = () => {
  return (
    <div className={styles.careers}>
      ...
      <section className={styles.careersHeroImage}>
        <img
          className={styles.carrersHeroBg}
          alt=""
          src="/carrers-hero-bg@2x.png"
        />
        <h1 className={styles.careers1}>Careers</h1>
        <div className={styles.tgsrtcIsHappyToAnnounceThWrapper}>
          <p className={styles.tgsrtcIsHappy}>
            TGSRTC is happy to announce the following package tours to our
            valuable commuters at affordable rates.
          </p>
        </div>
      </section>
      <section className={styles.animationParent}>
        <div className={styles.animation}>
          <img
            className={styles.busDust}
            loading="lazy"
            alt=""
            src="/bus--dust6@2x.png"
          />
        </div>
        <div className={styles.careersRecruitmentTable}>
          <div className={styles.tableTitle}>
            <h2 className={styles.title}>Recruitment in TGSRTC</h2>
              ...
              <div className={styles.table1}>
                ...
                <div className={styles.coulmn2}>
                  ...
                  <div className={styles.contentCell}>
                    <div className={styles.cells17}>
                      ...
                      <div className={styles.name19}>07:20</div>
                    </div>
                    <div className={styles.cells18}>
                      <div className={styles.bg17} />
                      <div className={styles.name20}>08:20</div>
                    </div>
                    <div className={styles.cells19}>
                      <div className={styles.bg18} />
                      <div className={styles.name21}>{`11:10  `}</div>
                    </div>
                ...
                <div className={styles.column3}>
                  <div className={styles.cells33}>
                    <b className={styles.name35}>Notification</b>
                  </div>
                ...
                <div className={styles.actionCell}>
                  ...
                  <button className={styles.contentCell11}>
                    <div className={styles.buttonCells}>
                      ...
                      <div className={styles.actions}>
                        ...
                        <div className={styles.button1}>
                          <div className={styles.viewDetails1}>Download</div>
                        </div>
