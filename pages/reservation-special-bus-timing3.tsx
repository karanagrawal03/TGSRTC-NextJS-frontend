  ...
  () => {
    return (
      <div className={styles.reservationSpecialBusTiming}>
        ...
        />
        <section className={styles.reservationYadagiriguttaToH}>
          <div className={styles.tabs}>
            ...
            <div className={styles.topTabs}>
              ...
              <div className={styles.tabs4}>
                <b className={styles.text3}>Yadagirigutta to Hyderabad</b>
              </div>
            </div>
          </div>
          <div className={styles.tableTitle}>
            <h2 className={styles.title}>
              <span className={styles.detailsOf}>{`Details of `}</span>
              <b>Yadagirigutta to Hyderabad</b>
              <span className={styles.busTimings}> bus timings</span>
            </h2>
              ...
              <form className={styles.table1}>
                ...
                <div className={styles.column3}>
                  <button className={styles.cells33}>
                    <div className={styles.name35}>Depot Name</div>
                  </button>
                  <div className={styles.contentCell1}>
                    ...
                    <div className={styles.cells35}>
                      ...
                      <div className={styles.name37}>Mahaboobnagar</div>
                    </div>
                ...
                <div className={styles.column4}>
                  ...
                  <div className={styles.contentCell2}>
                    ...
                    <div className={styles.cells52}>
                      ...
                      <div className={styles.name54}>Express</div>
                    </div>
                    <div className={styles.cells53}>
                      <div className={styles.bg50} />
                      <div className={styles.name55}>Express</div>
                    </div>
                ...
                <div className={styles.column5}>
                  ...
                  <div className={styles.contentCell3}>
                    <div className={styles.cells68}>
                      ...
                      <div className={styles.name70}>Yadagirigutta</div>
                    </div>
                    <button className={styles.cells69}>
                      <div className={styles.bg65} />
                      <div className={styles.name71}>Yadagirigutta</div>
                    </button>
                    <div className={styles.cells70}>
                      <div className={styles.bg66} />
                      <div className={styles.name72}>Yadagirigutta</div>
                    </div>
                    <button className={styles.cells71}>
                      <div className={styles.bg67} />
                      <div className={styles.name73}>Yadagirigutta</div>
                    </button>
                ...
                <div className={styles.column7}>
                  <button className={styles.cells101}>
                  ...
                  <div className={styles.contentCell5}>
                    <div className={styles.cells102}>
                      ...
                      <div className={styles.name104}>Hyderabad</div>
                    </div>
                    <button className={styles.cells103}>
                      <div className={styles.bg97} />
                      <div className={styles.name105}>Hyderabad</div>
                    </button>
                    <div className={styles.cells104}>
                      <div className={styles.bg98} />
                      <div className={styles.name106}>Hyderabad</div>
                    </div>
                    <button className={styles.cells105}>
                      <div className={styles.bg99} />
                      <div className={styles.name107}>Hyderabad</div>
                    </button>
                ...
                <div className={styles.column8}>
                  ...
                  <div className={styles.contentCell6}>
                    <div className={styles.cells119}>
                      ...
                      <div className={styles.name121}>06:40</div>
                    </div>
                    ...
                    <div className={styles.cells121}>
                      ...
                      <div className={styles.name123}>06:35</div>
                    </div>
        ...
        <footer className={styles.footer}>
          ...
          <div className={styles.recognitionAndSocialMediaC}>
            <div className={styles.recognitionSocialMediaWrapp}>
              <div className={styles.recognitionContainer}>
                ...
                <button className={styles.recognitionImageWrapper}>
                  <img
