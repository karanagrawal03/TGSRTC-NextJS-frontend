...
const FrameComponent2: NextPage<FrameComponent2Type> = ({ className = "" }) => {
  return (
    <div className={[styles.tableTitleWrapper, className].join(" ")}>
      <div className={styles.tableTitle}>
        <div className={styles.title}>Tariffs of monthly season tickets:</div>
        <div className={styles.table}>
          ...
          <div className={styles.table1}>
            ...
            <Coulmn
              ...
              propDisplay1="unset"
              propMinWidth1="unset"
              coulmn2AlignSelf="stretch"
              nameHeight="17px"
              nameFlex="1"
              cellsPadding="var(--spacing-lg) var(--padding-xl)"
              nameHeight1="17px"
              nameFlex1="1"
            ...
            <div className={styles.column3}>
              <div className={styles.cells16}>
                <b className={styles.name18}>KMs </b>
              </div>
            ...
            />
            <Column2
              name1="Rate of EXP MST (Monthly) Rs."
              name2="NO TICKET"
              namePlaceholder="NO TICKET"
              name3="1200.00"
              name4="1450.00"
              name5="1700.00"
              name6="1950.00"
