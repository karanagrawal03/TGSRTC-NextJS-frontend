...
import styles from "./reservation-details-of-reserva.module.css";
          ...
          <div className={styles.table1}>
            ...
            <div className={styles.column3}>
              <div className={styles.cells33}>
                <b className={styles.name35}>KMs </b>
              </div>
            ...
            <div className={styles.column4}>
              <div className={styles.cells50}>
                <b className={styles.name52}>City Ordinary(Rs.) </b>
              </div>
            ...
            <div className={styles.column7}>
              <div className={styles.cells101}>
                <b className={styles.name103}>Title</b>
              </div>
