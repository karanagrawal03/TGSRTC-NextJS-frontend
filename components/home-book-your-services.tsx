    ...
    <section className={[styles.homeBookYourServices, className].join(" ")}>
      <div className={styles.frameParent}>
        ...
        <p className={styles.telanganaStateRoad}>
          Telangana State Road Transport Corporation (TGSRTC) boasts a fleet of
          over 10,000 buses, serving major routes within Telangana and across
          states like Andhra Pradesh, Karnataka, Tamil Nadu, and Maharashtra.
          With operations spanning 36,593 routes in India, TSRTC is dedicated to
          offering top-notch facilities, punctual services, and affordable
          ticket prices for a safe and comfortable journey. Secure your TSRTC
          online booking today! 
        </p>
      </div>
      <div className={styles.bookYourServiceCards}>
        <Cards3
          group1000013321="/group-10000133211@2x.png"
        ...
        <div className={styles.cards}>
          ...
          <div className={styles.bodyContainer}>
            <div className={styles.texts}>
              <h2 className={styles.busPasses}>TGSRTC Logistics</h2>
              <p className={styles.loremIpsumDolorContainer}>
                <span className={styles.tgsrtcIntroducedCargo}>
                  TGSRTC introduced Cargo and Parcel Services in June 2020,
                  offering transportation of goods across the state and
                  neighboring areas. With designated counters at key locations
                  and appointed agents, consignors can conveniently book their
                  shipments at any TGSRTC bus station, ensuring efficient
                  delivery to their desired destinations for collection by the
                  consignee.
                </span>
              </p>
            </div>
