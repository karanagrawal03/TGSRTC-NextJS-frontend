    ...
    <div className={[styles.tableTitle, className].join(" ")}>
      ...
      <div className={styles.table}>
        ...
        <div className={styles.table1}>
          ...
          <Coulmn
            name1={`Time & KMs	`}
            name2="a) If BoC amount is below Rs.10,000/-	"
            name3="8 Hrs for 120KMs"
            name4="10 Hrs for 150KMs"
            name5="12 Hrs for 180KMs"
            name6="Item"
            showCoulmn2={false}
            cells
            cells1
          ...
          <div className={styles.column4}>
            <div className={styles.cells33}>
              <div className={styles.name35}>Amount to be deducted</div>
            </div>
            <div className={styles.contentCell1}>
              <div className={styles.cells34}>
                <div className={styles.bg32} />
                <div className={styles.name36}>Rs. 500/-</div>
              </div>
          ...
          <div className={styles.actionCell}>
            <div className={styles.cells186}>
              <div className={styles.name188}>Action</div>
            </div>
