...
const TableTitle: NextPage<TableTitleType> = ({ className = "" }) => {
  return (
        ...
        <div className={styles.table1}>
          ...
          <div className={styles.column5}>
            ...
            <div className={styles.contentCell3}>
              ...
              <div className={styles.cells69}>
                ...
                <div className={styles.name71}>Kumari Pokuri Srivalli</div>
              </div>
          ...
          <div className={styles.column6}>
            <div className={styles.cells84}>
              <div className={styles.name86}>Rate of EXP MST (Monthly) Rs.</div>
            </div>
