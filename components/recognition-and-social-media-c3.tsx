...
import styles from "./recognition-and-social-media-c3.module.css";
...
const RecognitionAndSocialMediaC: NextPage<RecognitionAndSocialMediaCType> = ({
  ...
  return (
    ...
    >
      <div className={styles.recognitionSocialMediaConte}>
        <div className={styles.recognitionContainer}>
          ...
          <button className={styles.recognitionImageContainer}>
            <img
