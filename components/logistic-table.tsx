...
import styles from "./logistic-table.module.css";

export type LogisticTableType = {
  className?: string;
};

const LogisticTable: NextPage<LogisticTableType> = ({ className = "" }) => {
  return (
    <section className={[styles.logisticTable, className].join(" ")}>
              ...
              <div className={styles.contentCell1}>
                ...
                <div className={styles.cells37}>
                  ...
                  <input
                    ...
                    placeholder={`GMR & TGSRTC Jointly Cargo Transport`}
                    type="text"
                  />
                </div>
