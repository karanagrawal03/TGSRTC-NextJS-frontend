...
import styles from "./reservation-muchintala.module.css";

export type ReservationMuchintalaType = {
  className?: string;
};

const ReservationMuchintala: NextPage<ReservationMuchintalaType> = ({
  className = "",
}) => {
  return (
    <section className={[styles.reservationMuchintala, className].join(" ")}>
      <div className={styles.tabsAboutMuchintala}>
        ...
        <div className={styles.muchintalaVillageInContainer}>
          <p className={styles.muchintalaVillageIn}>
            Muchintala village in Ranga Reddy district is now an international
            destination. Taking forward Sri Ramanuja’s ideals and philosophy,
            Sri Chinna Jeeyar Swamy has dreamt of a larger-than-life statue, the
            statue of equality, and a vast campus of worship for pilgrims. To
            help people reach the destination, TSRTC has arranged special buses
            to the statue of equality and has prepared a schedule for statue of
            equality bus timings.
          </p>
          <p className={styles.blankLine}>&nbsp;</p>
          <p className={styles.muchintalaBusTimings}>
            Muchintala bus timings are convenient and available. Now, the
            journey to Muchintala is easy and simple with TSRTC. For TSRTC buses
            to Muchintala refer to the below schedule. Have a safe and secure
            journey with TSRTC.
          </p>
        </div>
      </div>
        ...
        <div className={styles.table}>
          ...
          <form className={styles.table1}>
            ...
            <div className={styles.coulmn2}>
              <button className={styles.cells16}>
...
export default ReservationMuchintala;
