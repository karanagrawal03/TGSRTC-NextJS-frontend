...
import styles from "./reservation-yadagirigutta-to-h.module.css";

export type ReservationYadagiriguttaToHType = {
  className?: string;
};

const ReservationYadagiriguttaToH: NextPage<
  ReservationYadagiriguttaToHType
> = ({ className = "" }) => {
  return (
    <section
      className={[styles.reservationYadagiriguttaToH, className].join(" ")}
    >
      <div className={styles.tabsDetailsYadagiriguttaT}>
          ...
          <form className={styles.table1}>
            ...
            <div className={styles.column3}>
              <div className={styles.cells33}>
                <b className={styles.name35}>Depot Name</b>
              </div>
            ...
            <div className={styles.column4}>
              <div className={styles.cells50}>
                <b className={styles.name52}>Service Type</b>
              </div>
            ...
            <div className={styles.column5}>
              <button className={styles.cells67}>
                <b className={styles.name69}>From Stage</b>
              </button>
            ...
            <div className={styles.column6}>
              <div className={styles.cells84}>
                <b className={styles.name86}>From Time</b>
              </div>
            ...
            <div className={styles.column7}>
              <button className={styles.cells101}>
                <b className={styles.name103}>To Stage</b>
              </button>
            ...
            <div className={styles.column8}>
              <div className={styles.cells118}>
                <b className={styles.name120}>To Time</b>
              </div>
...
export default ReservationYadagiriguttaToH;
