  ...
  return (
    <div className={[styles.itemCellParent, className].join(" ")}>
      <div className={styles.itemCell}>
        ...
        >{`After 16 Hours, hire charges for 16 Hrs Plus @15KMs per Hour & Rate per KM`}</p>
      </div>
            ...
            <div className={styles.column4}>
              ...
              <div className={styles.contentCell1}>
                <div className={styles.cells34}>
                  ...
                  <div className={styles.name35}>Rs. 67.00</div>
                </div>
                <div className={styles.cells35}>
                  <div className={styles.bg33} />
                  <div className={styles.name36}>Rs 90.00</div>
                </div>
                <div className={styles.cells36}>
                  <div className={styles.bg34} />
                  <div className={styles.name37}>Rs 103.00</div>
                </div>
        ...
        <div className={styles.bulletPoints}>
          ...
          <div className={styles.bulletPoint2}>
            ...
            <p className={styles.monthlySeasonTickets2}>
              ...
              Corporation's business and provide the best possible service.
            </p>
          </div>
          <div className={styles.bulletPoint3}>
            ...
            <p className={styles.monthlySeasonTickets3}>
              GST component for all services: GST without ITC @5% (CGST-2.5% +
              SGST 2.5%) levied on the BoC amount + waiting charges + permit fee
              + BoC service charges.
            </p>
          </div>
          ...
          <div className={styles.bulletPoint6}>
            ...
            >{`In case of city service BoC, upto 50 Kms radius bookings, no Toll Charges shall be collected. For the city type BoC's booked for destinations over & above 50 Kms, the Toll Plaza charges @ Rs.5/- per km shall be collected.`}</p>
          </div>
          ...
          <div className={styles.bulletPoint8}>
            ...
            <p className={styles.monthlySeasonTickets8}>
              ...
              charges which shall be deducted from BoC amount paid by the party
              are tabulated below:
            </p>
          </div>
