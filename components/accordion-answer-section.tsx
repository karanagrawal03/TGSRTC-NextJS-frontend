...
import styles from "./accordion-answer-section.module.css";

export type AccordionAnswerSectionType = {
  className?: string;
};

const AccordionAnswerSection: NextPage<AccordionAnswerSectionType> = ({
  className = "",
}) => {
  return (
    <div className={[styles.accordionAnswerSection, className].join(" ")}>
      <div className={styles.noteWrapper}>
        <div className={styles.note}>
          <b className={styles.httpsonlinetgsrtcpassinc}>
            https://online.TGSRTCpass.in/counterstupass.do?prm=hyd
          </b>
        </div>
      </div>
      <div className={styles.busPassContent}>
        <div className={styles.aStudentQuarterlyRouteBus}>
          <BulletPointContainer1
            guidingPrinciplesOfTGSRTC="a. Student Quarterly Route Bus Pass"
              ...
              <div className={styles.table1}>
                ...
                <div className={styles.column4}>
                  <div className={styles.cells50}>
                    <b className={styles.name52}>Name</b>
                  </div>
            ...
            <div className={styles.bulletPoints}>
              ...
              <div className={styles.bulletPoint1}>
                ...
                <p className={styles.monthlySeasonTickets1}>
                  Applicant can apply online at www.online.TGSRTCpass.in
                </p>
              </div>
        ...
        <div className={styles.bStudentGeneralBusTicket}>
          <BulletPointContainer1
            guidingPrinciplesOfTGSRTC="b. Student General Bus Ticket:"
            ...
            bulletPointFlex="unset"
            bulletPointWidth="1104px"
            bulltetPointPlaceholderFlexWrap="unset"
            bulltetPointPlaceholderPadding1="0px 0px 0px 0px"
            monthlySeasonTicketsMinHeight="26px"
            propFlex="unset"
            propMinWidth="unset"
            propWidth="1104px"
          />
          <div className={styles.tableTitle1}>
              ...
              <form className={styles.table3}>
                ...
                <div className={styles.actionCell1}>
                  <div className={styles.cells407}>
                    <div className={styles.name410}>Action</div>
                  </div>
            ...
            <img className={styles.scrollIcon1} alt="" />
          </div>
            ...
            <div className={styles.bulletPoints1}>
              <div className={styles.bulletPoint20}>
                ...
                <p className={styles.monthlySeasonTickets20}>
                  Travel facility valid anywhere to anywhere within
                  City/Sub-Urban limits.
                </p>
              </div>
              <div className={styles.bulletPoint21}>
                ...
                >{`Validity period –1 month & 3 months for monthly and Quarterly passes respectively.`}</p>
              </div>
        ...
        <div className={styles.cStudentGreaterHyderabadB}>
          <div className={styles.bulletPointContainer2}>
            <div className={styles.title4}>
              <p className={styles.guidingPrinciplesOf2}>
                c. Student Greater Hyderabad Bus Pass ( Monthly/Quarterly)
              </p>
            </div>
            <div className={styles.bulletPoints2}>
              <div className={styles.bulletPoint40}>
                <img
                  className={styles.bulltetPointPlaceholder40}
                  alt=""
                  src="/bulltet-point-placeholder.svg"
                />
                <p className={styles.monthlySeasonTickets40}>
                  Eligible for the Students above 12 years age.
                </p>
              </div>
              <div className={styles.bulletPoint41}>
                <img className={styles.bulltetPointPlaceholder41} alt="" />
                <div className={styles.monthlySeasonTickets41}>
                  To provide employee satisfaction in financial and humanistic
                  terms.
                </div>
              </div>
              <div className={styles.bulletPoint42}>
                <img className={styles.bulltetPointPlaceholder42} alt="" />
                <div className={styles.monthlySeasonTickets42}>
                  To strive towards financial self-reliance in regard to
                  performance and growth.
                </div>
              </div>
              <div className={styles.bulletPoint43}>
                <img className={styles.bulltetPointPlaceholder43} alt="" />
                <div className={styles.monthlySeasonTickets43}>
                  To attain a position of reputation and respect in the society.
                </div>
              </div>
              <div className={styles.bulletPoint44}>
                <img className={styles.bulltetPointPlaceholder44} alt="" />
                <div className={styles.monthlySeasonTickets44}>
                  To regularly and constantly improve the capabilities of
                  employees for higher productivity.
                </div>
              </div>
              <div className={styles.bulletPoint45}>
                <img className={styles.bulltetPointPlaceholder45} alt="" />
                <div className={styles.monthlySeasonTickets45}>
                  To focus on service conditions and welfare of the employees
                  and their families consistent with their worth to the
                  Corporation.
                </div>
              </div>
              <div className={styles.bulletPoint46}>
                <img className={styles.bulltetPointPlaceholder46} alt="" />
                <div className={styles.monthlySeasonTickets46}>
                  To fulfill its obligation to the State and Central governments
                  by optimizing return on investment.
                </div>
              </div>
              <div className={styles.bulletPoint47}>
                <img className={styles.bulltetPointPlaceholder47} alt="" />
                <div className={styles.monthlySeasonTickets47}>
                  To emphasize environmental and community concerns in the form
                  of reducing air and noise pollution.
                </div>
              </div>
              <div className={styles.bulletPoint48}>
                <img className={styles.bulltetPointPlaceholder48} alt="" />
                <div className={styles.monthlySeasonTickets48}>
                  To consciously conform to the policy guidelines of the State
                  in its business operations.
                </div>
              </div>
              <div className={styles.bulletPoint49}>
                <img className={styles.bulltetPointPlaceholder49} alt="" />
                <div className={styles.monthlySeasonTickets49}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint50}>
                <img className={styles.bulltetPointPlaceholder50} alt="" />
                <div className={styles.monthlySeasonTickets50}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint51}>
                <img className={styles.bulltetPointPlaceholder51} alt="" />
                <div className={styles.monthlySeasonTickets51}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint52}>
                <img className={styles.bulltetPointPlaceholder52} alt="" />
                <div className={styles.monthlySeasonTickets52}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint53}>
                <img className={styles.bulltetPointPlaceholder53} alt="" />
                <div className={styles.monthlySeasonTickets53}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint54}>
                <img className={styles.bulltetPointPlaceholder54} alt="" />
                <div className={styles.monthlySeasonTickets54}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint55}>
                <img className={styles.bulltetPointPlaceholder55} alt="" />
                <div className={styles.monthlySeasonTickets55}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint56}>
                <img className={styles.bulltetPointPlaceholder56} alt="" />
                <div className={styles.monthlySeasonTickets56}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint57}>
                <img className={styles.bulltetPointPlaceholder57} alt="" />
                <div className={styles.monthlySeasonTickets57}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint58}>
                <img className={styles.bulltetPointPlaceholder58} alt="" />
                <div className={styles.monthlySeasonTickets58}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint59}>
                <img className={styles.bulltetPointPlaceholder59} alt="" />
                <div className={styles.monthlySeasonTickets59}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
            </div>
          ...
          <div className={styles.tableTitle2}>
            ...
            <div className={styles.table4}>
              ...
              <div className={styles.table5}>
                ...
                <div className={styles.column42}>
                  <input
                    className={styles.cells458}
                    placeholder="Monthly Tariff (Rs.)"
                    type="text"
                  />
                  <div className={styles.contentCell26}>
                    <div className={styles.cells459}>
                      <div className={styles.bg464} />
                      <p className={styles.name463}>
                        400.00 + 70.00 per E.2 KMs beyond Sub-urban limits in
                        particular District place of the route.
                      </p>
                    </div>
                    <div className={styles.cells460}>
                      <div className={styles.bg465} />
                      <p className={styles.name464}>
                        1200.00 + 210.00 per E.2 KMs beyond Sub-urban limits in
                        particular District place of the route.
                      </p>
                    </div>
                    <div className={styles.cells461}>
                      <div className={styles.bg466} />
                      <div className={styles.name465}>900.00</div>
                    </div>
                    <div className={styles.cells462}>
                      <div className={styles.bg467} />
                      <div className={styles.name466}>1150.00</div>
                    </div>
                    <div className={styles.cells463}>
                      <div className={styles.bg468} />
                      <div className={styles.name467}>1350.00</div>
                    </div>
                ...
                <div className={styles.column62}>
                  <div className={styles.cells492}>
                    <div className={styles.name496}>Title</div>
                  </div>
                  <div className={styles.contentCell28}>
                    ...
                    <div className={styles.cells494}>
                      ...
                      <div className={styles.name498}>Item</div>
                    </div>
                ...
                <div className={styles.column72}>
                  <div className={styles.cells509}>
                    <div className={styles.name513}>Title</div>
                  </div>
                  <div className={styles.contentCell29}>
                    ...
                    <div className={styles.cells511}>
                      ...
                      <div className={styles.name515}>Item</div>
                    </div>
                ...
                <div className={styles.column82}>
                  <div className={styles.cells526}>
                    <div className={styles.name530}>Title</div>
                  </div>
                  <div className={styles.contentCell30}>
                    ...
                    <div className={styles.cells528}>
                      ...
                      <div className={styles.name532}>Item</div>
                    </div>
                ...
                <div className={styles.column92}>
                  <div className={styles.cells543}>
                    <div className={styles.name547}>Title</div>
                  </div>
                  <div className={styles.contentCell31}>
                    ...
                    <div className={styles.cells545}>
                      ...
                      <div className={styles.name549}>Item</div>
                    </div>
                ...
                <div className={styles.column102}>
                  <div className={styles.cells560}>
                    <div className={styles.name564}>Title</div>
                  </div>
                  <div className={styles.contentCell32}>
                    ...
                    <div className={styles.cells562}>
                      ...
                      <div className={styles.name566}>Item</div>
                    </div>
                ...
                <div className={styles.column112}>
                  <div className={styles.cells577}>
                    <div className={styles.name581}>Title</div>
                  </div>
                  <div className={styles.contentCell33}>
                    ...
                    <div className={styles.cells579}>
                      ...
                      <div className={styles.name583}>Item</div>
                    </div>
                ...
                <div className={styles.column122}>
                  <div className={styles.cells594}>
                    <div className={styles.name598}>Title</div>
                  </div>
                  <div className={styles.contentCell34}>
                    ...
                    <div className={styles.cells596}>
                      ...
                      <div className={styles.name600}>Item</div>
                    </div>
                ...
                <div className={styles.actionCell2}>
                  <div className={styles.cells611}>
                    <div className={styles.name615}>Action</div>
                  </div>
            ...
            <img className={styles.scrollIcon2} alt="" />
          </div>
          <div className={styles.bulletPointContainer3}>
            <div className={styles.title6}>
              <div className={styles.guidingPrinciplesOf3}>
                Corporate Philosophy
              </div>
            </div>
            <div className={styles.bulletPoints3}>
              <div className={styles.bulletPoint60}>
                <img
                  className={styles.bulltetPointPlaceholder60}
                  alt=""
                  src="/bulltet-point-placeholder.svg"
                />
                <p className={styles.monthlySeasonTickets60}>
                  Travel facility valid anywhere to anywhere within City /
                  Sub-Urban limits and particular District place on the Route.
                </p>
              </div>
              <div className={styles.bulletPoint61}>
                <img
                  className={styles.bulltetPointPlaceholder61}
                  alt=""
                  src="/bulltet-point-placeholder.svg"
                />
                <p
                  className={styles.monthlySeasonTickets61}
                >{`Validity period – 1 month & 3 months for monthly and Quarterly passes respectively.`}</p>
              </div>
              <div className={styles.bulletPoint62}>
                <img
                  className={styles.bulltetPointPlaceholder62}
                  alt=""
                  src="/bulltet-point-placeholder.svg"
                />
                <p className={styles.monthlySeasonTickets62}>
                  Applicant can apply online at www.online.TGSRTCpass.in
                </p>
              </div>
              <div className={styles.bulletPoint63}>
                <img className={styles.bulltetPointPlaceholder63} alt="" />
                <div className={styles.monthlySeasonTickets63}>
                  To attain a position of reputation and respect in the society.
                </div>
              </div>
              <div className={styles.bulletPoint64}>
                <img className={styles.bulltetPointPlaceholder64} alt="" />
                <div className={styles.monthlySeasonTickets64}>
                  To regularly and constantly improve the capabilities of
                  employees for higher productivity.
                </div>
              </div>
              <div className={styles.bulletPoint65}>
                <img className={styles.bulltetPointPlaceholder65} alt="" />
                <div className={styles.monthlySeasonTickets65}>
                  To focus on service conditions and welfare of the employees
                  and their families consistent with their worth to the
                  Corporation.
                </div>
              </div>
              <div className={styles.bulletPoint66}>
                <img className={styles.bulltetPointPlaceholder66} alt="" />
                <div className={styles.monthlySeasonTickets66}>
                  To fulfill its obligation to the State and Central governments
                  by optimizing return on investment.
                </div>
              </div>
              <div className={styles.bulletPoint67}>
                <img className={styles.bulltetPointPlaceholder67} alt="" />
                <div className={styles.monthlySeasonTickets67}>
                  To emphasize environmental and community concerns in the form
                  of reducing air and noise pollution.
                </div>
              </div>
              <div className={styles.bulletPoint68}>
                <img className={styles.bulltetPointPlaceholder68} alt="" />
                <div className={styles.monthlySeasonTickets68}>
                  To consciously conform to the policy guidelines of the State
                  in its business operations.
                </div>
              </div>
              <div className={styles.bulletPoint69}>
                <img className={styles.bulltetPointPlaceholder69} alt="" />
                <div className={styles.monthlySeasonTickets69}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint70}>
                <img className={styles.bulltetPointPlaceholder70} alt="" />
                <div className={styles.monthlySeasonTickets70}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint71}>
                <img className={styles.bulltetPointPlaceholder71} alt="" />
                <div className={styles.monthlySeasonTickets71}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint72}>
                <img className={styles.bulltetPointPlaceholder72} alt="" />
                <div className={styles.monthlySeasonTickets72}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint73}>
                <img className={styles.bulltetPointPlaceholder73} alt="" />
                <div className={styles.monthlySeasonTickets73}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint74}>
                <img className={styles.bulltetPointPlaceholder74} alt="" />
                <div className={styles.monthlySeasonTickets74}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint75}>
                <img className={styles.bulltetPointPlaceholder75} alt="" />
                <div className={styles.monthlySeasonTickets75}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint76}>
                <img className={styles.bulltetPointPlaceholder76} alt="" />
                <div className={styles.monthlySeasonTickets76}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint77}>
                <img className={styles.bulltetPointPlaceholder77} alt="" />
                <div className={styles.monthlySeasonTickets77}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint78}>
                <img className={styles.bulltetPointPlaceholder78} alt="" />
                <div className={styles.monthlySeasonTickets78}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
              <div className={styles.bulletPoint79}>
                <img className={styles.bulltetPointPlaceholder79} alt="" />
                <div className={styles.monthlySeasonTickets79}>
                  To reach a position of pre-eminence in bus transport business.
                </div>
              </div>
            </div>
...
export default AccordionAnswerSection;
